...
public class UsuarioDetallesController {
    ...
    @FXML private TableView<com.farmaciavictoria.proyectopharmavictoria.model.Usuario.UsuarioHistorialAcceso> accesosTable;
    @FXML private TableColumn<com.farmaciavictoria.proyectopharmavictoria.model.Usuario.UsuarioHistorialAcceso, String> colAccesoFecha;
    @FXML private TableColumn<com.farmaciavictoria.proyectopharmavictoria.model.Usuario.UsuarioHistorialAcceso, String> colAccesoIp;
    @FXML private TableColumn<com.farmaciavictoria.proyectopharmavictoria.model.Usuario.UsuarioHistorialAcceso, String> colAccesoDispositivo;
    @FXML private TableView<com.farmaciavictoria.proyectopharmavictoria.model.Usuario.UsuarioHistorialCambio> auditoriaTable;
    @FXML private TableColumn<com.farmaciavictoria.proyectopharmavictoria.model.Usuario.UsuarioHistorialCambio, String> colAuditoriaFecha;
    @FXML private TableColumn<com.farmaciavictoria.proyectopharmavictoria.model.Usuario.UsuarioHistorialCambio, String> colAuditoriaAccion;
    @FXML private TableColumn<com.farmaciavictoria.proyectopharmavictoria.model.Usuario.UsuarioHistorialCambio, String> colAuditoriaUsuario;
    @FXML private TableColumn<com.farmaciavictoria.proyectopharmavictoria.model.Usuario.UsuarioHistorialCambio, String> colAuditoriaDetalle;
    ...
    public void cargarUsuario(Usuario usuario) {
        ...
        lblUsername.setText((usuario != null && usuario.getUsername() != null && !usuario.getUsername().isEmpty()) ? usuario.getUsername() : "-");
        lblNombres.setText((usuario != null && usuario.getNombres() != null && !usuario.getNombres().isEmpty()) ? usuario.getNombres() : "-");
        lblApellidos.setText((usuario != null && usuario.getApellidos() != null && !usuario.getApellidos().isEmpty()) ? usuario.getApellidos() : "-");
        lblDni.setText((usuario != null && usuario.getDni() != null && !usuario.getDni().isEmpty()) ? usuario.getDni() : "-");
        lblTelefono.setText((usuario != null && usuario.getTelefono() != null && !usuario.getTelefono().isEmpty()) ? usuario.getTelefono() : "-");
        lblEmail.setText((usuario != null && usuario.getEmail() != null && !usuario.getEmail().isEmpty()) ? usuario.getEmail() : "-");
        lblRol.setText((usuario != null && usuario.getRol() != null) ? usuario.getRol().name() : "-");
        if (usuario != null && usuario.getSucursalId() != null) {
            String sucursalStr = String.valueOf(usuario.getSucursalId());
            lblSucursal.setText(!sucursalStr.equals("null") && !sucursalStr.trim().isEmpty() ? sucursalStr : "-");
        } else {
            lblSucursal.setText("-");
        }
        lblUltimoAcceso.setText((usuario != null && usuario.getUltimoAcceso() != null) ? usuario.getUltimoAcceso().toString() : "-");
        ...
        if (usuario != null && usuario.getId() != null) {
            ...
            com.farmaciavictoria.proyectopharmavictoria.service.UsuarioService usuarioService = com.farmaciavictoria.proyectopharmavictoria.service.UsuarioService.getInstance();
            java.util.List<com.farmaciavictoria.proyectopharmavictoria.model.Usuario.UsuarioHistorialAcceso> accesos = usuarioService.obtenerHistorialAccesos(usuario.getId());
            if (accesos != null && !accesos.isEmpty()) {
                accesosTable.getItems().addAll(accesos);
            }
            java.util.List<com.farmaciavictoria.proyectopharmavictoria.model.Usuario.UsuarioHistorialCambio> auditoria = usuarioService.obtenerHistorialCambios(usuario.getId());
    ...
    public void initialize() {
        ...
        colAuditoriaUsuario.setCellValueFactory(data -> {
            ...
            java.util.Optional<com.farmaciavictoria.proyectopharmavictoria.model.Usuario.Usuario> usuarioOpt = usuarioRepo.findById(id.longValue());
            if (usuarioOpt.isPresent()) {
                com.farmaciavictoria.proyectopharmavictoria.model.Usuario.Usuario u = usuarioOpt.get();
                String nombre = (u.getNombres() != null ? u.getNombres() : "") + " " + (u.getApellidos() != null ? u.getApellidos() : "");
                return new javafx.beans.property.SimpleStringProperty(nombre.trim().isEmpty() ? u.getUsername() : nombre.trim());
            } else {
        ...
        // Forzar estilo de los encabezados en tiempo de ejecución (override de hojas CSS cargadas después)
        fixTableHeaders(accesosTable);
        fixTableHeaders(auditoriaTable);

        // Reemplazar los headers de las columnas por Labels con estilo inline (solución definitiva)
    ...
    // Método auxiliar que busca los nodos de header en una TableView y aplica estilos inline
