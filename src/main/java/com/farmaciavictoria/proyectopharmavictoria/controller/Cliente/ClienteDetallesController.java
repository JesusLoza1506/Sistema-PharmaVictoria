...
public class ClienteDetallesController {
    ...
    private final com.farmaciavictoria.proyectopharmavictoria.service.HistorialComprasService comprasService = new com.farmaciavictoria.proyectopharmavictoria.service.HistorialComprasService();
    @FXML
    ...
    public void setCliente(Cliente cliente) {
        ...
        puntosTotalesLabel
                .setText(cliente.getPuntosTotales() != null ? String.valueOf(cliente.getPuntosTotales()) : "0");
    ...
    private void cargarHistorial(Integer clienteId) {
        ...
        colCampo.setCellValueFactory(
                data -> new javafx.beans.property.SimpleStringProperty(data.getValue().getCampoModificado()));
        colAnterior.setCellValueFactory(
                data -> new javafx.beans.property.SimpleStringProperty(data.getValue().getValorAnterior()));
        colNuevo.setCellValueFactory(
                data -> new javafx.beans.property.SimpleStringProperty(data.getValue().getValorNuevo()));
    ...
    private void cargarHistorialPuntos(Integer clienteId) {
        ...
        colPuntosTipo
                .setCellValueFactory(data -> new javafx.beans.property.SimpleStringProperty(data.getValue().getTipo()));
        colPuntosValor.setCellValueFactory(
                data -> new javafx.beans.property.SimpleIntegerProperty(data.getValue().getPuntos()).asObject());
    ...
    private void cargarHistorialCompras(Integer clienteId) {
        ...
        com.farmaciavictoria.proyectopharmavictoria.service.Ventas.VentaServiceImpl ventaService = new com.farmaciavictoria.proyectopharmavictoria.service.Ventas.VentaServiceImpl(
                new com.farmaciavictoria.proyectopharmavictoria.repository.Ventas.VentaRepositoryJdbcImpl(), null, null,
                null, null);
