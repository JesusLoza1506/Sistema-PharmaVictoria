...
public class ReporteVentasPorUsuarioCardController {
    @FXML
    ...
    private void abrirDetalle(MouseEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(
                    getClass().getResource("/fxml/reportes/ReporteVentasPorUsuarioDetalle.fxml"));
            Parent detalleRoot = loader.load();
            Stage stage = new Stage();
            stage.setTitle("Reporte de Ventas por Usuario");
